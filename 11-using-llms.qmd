...
באפשרותכם להשתמש בקישור הבא: https://www.hebrewr.co.il/04-visualizations-ggplot2_files/figure-html/pengions%20vis%203%20with%20linear%20regression%20lines-1.png
...
```         
car_models <- c("סוזוקי-יפן", "פורד ספרד", "ב מ וו בריטניה",  "טויוטה ארהב", "יונדאי צ'כיה", "יונדאי טורקיה",  "פיאט פולין", "אופל-ספרד", "דאציה מרוקו",  "פולקסווגן פורט", "רנו ד.קוריאה", "מזדה תאילנד",  "אופל פולין", "גיי.איי.סי סין", "סוזוקי תאילנד",  "פורד-בלגיה", "אודי מכסיקו", "פורד רומניה",  "פורשה סלובקיה", "מיצובישי הולנד", "דימלרקריזלר-ספ",  "פיאט סרביה", "קרייזלר מכסיקו", "פורד בריטניה",  "טויוטה בלגיה", "קיי גי מוביליט", "האמר ג.מ. דרום",  "פיאט פורטוגל", "ב מ וו מקסיקו", "לנציה פולין",  "גיאיוואן סין", "סנטרו סין", "טויוטה צרפת",  "טויוטה יפן", "וולבו שוודיה", "סיאט ספרד",  "מיצובישי תאילנ", "מקסוס סין", "הונדה בריטניה",  "מרוטי-סוזוקי", "לנצ'יה", "מ.ג סין", "מזארטי איטליה",  "קאדילאק מכסיקו", "הונדה מקסיקו", "סיטרואן סלובק",  "מרצדס בנץ הונג", "אורה סין", "פיאט תאילנד",  "ב מ וו אוסטריה")
```
